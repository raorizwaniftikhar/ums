							...
							<div>
								...
								<div class="mt-2">
									...
									<form:form name="register" id="register"
										modelAttribute="userRegistrationForm" action="${actionUrl}"
										method="post">
										<div class="form-group">
											<form:input type="text" class="form-control" id="firstName"
												path="firstName" value="" placeholder="Enter First name" />
											<form:errors path="firstName" class="control-label has-error" />
										</div>
										<div class="form-group">
											<form:input type="text" class="form-control" id="lastName"
												path="lastName" value="" placeholder="Enter Last name" />
											<form:errors path="lastName" class="control-label has-error" />
										</div>
										<div class="form-group">
											<form:input type="email" class="form-control" id="email"
												path="email" value="" placeholder="Enter email address" />
										...
										<div class="form-group">
											<form:input type="password" class="form-control"
												id="confirmpassword" path="matchingPassword" value=""
										...
										<div class="form-group">
											<form:input type="text" class="form-control" id="companyName"
												path="companyName" value="" placeholder="Enter Company Name" />
											<form:errors path="companyName"
												class="control-label has-error" />
										</div>
										<div class="form-group">
											<form:input type="url" class="form-control" id="companyUrl"
												path="companyUrl" value="" placeholder="Enter Company Url" />
											<form:errors path="companyUrl"
												class="control-label has-error" />
										</div>

										<form:input type="hidden" id="socialProvider"
											path="socialProvider" value="LOCAL" />
										<button type="submit" class="btn btn-primary btn-block"
											id="doRegister">Create Account</button>
									</form:form>
